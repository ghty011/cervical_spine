...
def train(hyp, opt, device, tb_writer=None):
    ...
    # test preparation
    boundary_df = pd.read_csv(boundary_df_path)
    train_df = pd.read_csv(train_df_path).set_index('StudyInstanceUID')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log-size', action='store_true', help='log UID size')
